...
function setFocusInfo(focusKey) {
  ...
  if (focusKey === 0) { // LUPO
    ...
    focusSubheading = 'A playful exploration of how to display your holiday photos';
    focusPara1 =
  ...
  } else if (focusKey === 5) { // Eclipse
    focusRepo = 'https://github.com/pablisch/eclipse-layout-react'
    focusPageMessage = "Select or deselect names from the player form and click the <span class='bold'>GENERATE</span> button to generate the starting game layout.";
    focusUrl = 'https://eclipse-generator.onrender.com/';
    focusHeading = 'Eclipse Layout Generator';
    focusSubheading = 'A companion to the board game, Eclipse, A new Dawn for the Galaxy';
    focusPara1 =
