...
function setFocusInfo(focusKey) {
  ...
  if (focusKey === 0) { // LUPO
    ...
    focusPageMessage =
      'As this is hosted on a free tirr of Render, the backend may take up to 30 seconds to spin up. The app will not work until the backend is running. Please be patient';
